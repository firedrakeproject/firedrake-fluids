...
def steady_channel_flow():
   sw = shallow_water.ShallowWater(path=os.path.join(cwd, "steady_channel_flow.swml"))
   sw.run()
...
def test_steady_channel_flow():
   ux_values, uy_values, h_values = numpy.array(steady_channel_flow())
