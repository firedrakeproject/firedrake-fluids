...
\begin{figure}[!ht]
   \centering
   \includegraphics[width=1\columnwidth]{images/ufl_expression.png}
...
\begin{figure}[!ht]
   \centering
   \includegraphics[width=1\columnwidth]{images/c_kernel.png}
