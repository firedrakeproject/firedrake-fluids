...
Users can also enable checkpointing which allows them to resume the simulation at a later time. The time interval between checkpoint dumps can be specified under \texttt{io/checkpoint/dump\_period}. However, this option will only work with the \texttt{-c} flag when executing the shallow water model.
