...
In the case of the mesh file location, note that only Gmsh \texttt{.msh} files are supported.
...
For the free surface field, only Dirichlet boundary conditions are available.
